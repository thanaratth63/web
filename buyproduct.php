...
<body class="container">
    ...
    <h1>Buy Product</h1>
    <a class="btn btn-danger btn-default pull-right" href="indexpj.php" role="button"><span class="glyphicon glyphicon-home" aria-hidden="true"></span></a>
        <!-- <a href="indexpj.php"><input class="btn btn-danger pull-right" type="submit" value="Back to home"></a>  -->
    ...
    <form class="form-inline" method="get" action="">
        ...
        &nbsp;&nbsp;&nbsp; 
        <input class="btn btn-primary btn-sm" type="submit" value="Enter">
    </form>
    </form>
    <br>
        <table class="table">
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo "Bath" ?></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a class="btn btn-success btn-default pull-right" href="addorder.php?idproduct=<?php echo $row['idproduct']; ?>" role="button"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></a>&nbsp;&nbsp;
                        
                        <!-- <a class="btn btn-danger btn-lg" href="deleteproduct.php?itemid=<?php echo $row['idmodel']; ?>" role="button"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a> -->
                    </td>
                </tr>
            <?php
            }
