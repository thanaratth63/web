        ...
        <div class="row">
            <div class="col-md-4 mx-auto">
                <form action="" method="post">
                    <br><br>
                    <center><h4 class="mb-4 pb-3">Sing Up</h4></center>
                    <p>
                    ...
                    <center><button type="submit" class="btn btn-success">Create </button> &nbsp; &nbsp;
                    <a href="loginpj.php"><button type="submit" class="btn btn-success">Sing Up</button></a></center>
                </form>
            </div>
        </div>
    </div>
